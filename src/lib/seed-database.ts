    ...
    const contractors = await Promise.all([
      prisma.contractor.create({
        data: {
          ...
          skillTags: ['Heavy Equipment Operation', 'Site Safety', 'Excavator Operation'],
          isAvailable: true,
          maxHoursPerWeek: 50,
        },
      }),
      prisma.contractor.create({
        data: {
          ...
          skillTags: ['Crane Operation', 'Equipment Maintenance', 'Site Management'],
          isAvailable: false,
      ...
      prisma.contractor.create({
        data: {
          ...
          hourlyRate: 75.00,
          dailyRate: 600.00,
          skillTags: ['Drill Operation', 'Safety Training', 'First Aid'],
          isAvailable: true,
          maxHoursPerWeek: 40,
        },
      }),
